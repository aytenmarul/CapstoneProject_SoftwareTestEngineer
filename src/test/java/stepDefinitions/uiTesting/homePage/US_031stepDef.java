...
public class US_031stepDef  {
    ...
    public void user_clicks_on_the_register_button_on_the_navbar() {
        ...
        // . -> class
        // # -> id
        WebElement registerButton = commonPage.getHomePage().registerButton_navbar;// ctrl alt  v
    ...
    public void user_send_a_to_first_name_on_the_registration_form() {
        ...
        a.moveToElement(firstName).build().perform();
...
// omer -> 4 -> 4 defa backspace
    ...
    @Given("user goes to website d n")
    public void userGoesToWebsiteDN() {
    }
}
